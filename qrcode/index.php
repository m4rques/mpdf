<?php
	...
	require_once('../../../gerando-pdf-com-mpdf/mpdf60/qrcode/qrcode.class.php');
?>
...
?>
			...
			<img src="../../../gerando-pdf-com-mpdf/mpdf60/qrcode/image.php?msg=<?php echo urlencode($msg); ?>&err=<?php echo urlencode($err); ?>" alt="generation qr-code" style="border: solid 1px black;">
		</center>
	</body>
</html>