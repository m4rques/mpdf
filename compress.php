...
if (function_exists('file_put_contents')) {
	$check = file_put_contents('../../gerando-pdf-com-mpdf/mpdf60/mpdf.php', $x);
}
else {
	$f=fopen('../../gerando-pdf-com-mpdf/mpdf60/mpdf.php', 'w');
	$check = fwrite($f, $x);
	fclose($f);
}
...
include('../../gerando-pdf-com-mpdf/mpdf60/mpdf.php');
$mpdf = new mPDF();
